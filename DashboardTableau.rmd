...
4. Use appropriate tiles and axis labels for each individual chart and a meaningful title for the dashboard.
...
2. Write a simple HTML and put both Tableau dashboard and story-point on the same web page using the code provided by Tableau to embed into a web page using the template given below.



**HTML Template and Publish It on GitHub**
